...
class MagazineRepositoryImpl(private val magazineRemoteSource: MagazineRemoteSource) : MagazineRepository {

    override suspend fun getMagazineList(year: String, search: String): Result<Failure, MagazineModel> {
